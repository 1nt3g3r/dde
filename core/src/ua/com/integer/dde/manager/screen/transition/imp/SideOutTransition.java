package ua.com.integer.dde.manager.screen.transition.imp;
...
import ua.com.integer.dde.manager.screen.transition.ScreenshotActionTransition;
...
public class SideOutTransition extends ScreenshotActionTransition {
	...
	public static SideOutTransition random() {
		int side = MathUtils.random(TOP_SIDE, RIGHT_SIDE);
		return new SideOutTransition(side);
	}
}
