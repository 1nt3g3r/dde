package ua.com.integer.dde.manager.set;

import ua.com.integer.dde.manager.CompositeLoadManager;
import ua.com.integer.dde.manager.PathDescriptorLoadManager;
import ua.com.integer.dde.manager.descriptor.CompositePathDescriptor;
import ua.com.integer.dde.manager.descriptor.PathDescriptor;
import ua.com.integer.dde.manager.set.resolver.AtlasResolver;
import ua.com.integer.dde.manager.set.resolver.MusicResolver;
import ua.com.integer.dde.manager.set.resolver.ResourceResolver;
import ua.com.integer.dde.manager.set.resolver.SoundResolver;
import ua.com.integer.dde.manager.set.resolver.TTFFontManagerResolver;
import ua.com.integer.dde.manager.set.resolver.TextureResolver;
